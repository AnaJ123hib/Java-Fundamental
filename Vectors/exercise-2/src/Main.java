...
public class Main {
    static void Listado_ordenado(Object[][] listClientes){
    ...
    static  int Promedio_edad(Object[][] listClients){
        int count = 0;
        int sum = 0;
    ...
    static int Porcentaje_4y8_malo(Object[][] listClients){
        int count = 0;
        ...
        return ((int) ( count * 100 / listClients.length));
    }
    static void Generar_y_Mostrar(Object[][] listClients){
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            if(clientsNumber > 0 && clientsNumber <= 100){
                ...
                Generar_y_Mostrar(listClients);
                System.out.println("Resultados: ");
                System.out.println("Porcentaje de clientes entre 4 y 8 años y grado de satisfacción malo: " + Porcentaje_4y8_malo(listClients) + "%");
                System.out.println("Promedio de edad de clientes que consideran excelente el servicio: " + Promedio_edad(listClients));
                Listado_ordenado(listClients);
                break;
            }
        }
